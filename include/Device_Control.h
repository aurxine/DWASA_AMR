...
public:
    ...
    uint8_t Water_per_Pulse_start_address = Number_of_saved_contacts_address;
    ...
    bool get_Contact(String number);//gets a number and appends it to the array
    ...
    void get_Water_per_Pulse(byte amount);//saves water flow per pulse data
